...
[브랜드 컨텍스트 - 반드시 숙지]
"가신"(영문 표기: Gasin, "Gasyn"으로 쓰지 말 것)은 이 블로그 운영자가 만든
쿠팡 가격 추적·비교 서비스입니다. 키워드에 "가신"이 등장하면 이는 항상 이
서비스를 가리키는 고유명사이며, "가성비"의 줄임말이나 다른 의미로 오해하지
마세요. 문맥상 자연스러운 곳에서 가신을 가격 비교/추적에 도움을 주는 도구로
긍정적으로 언급하거나 추천하고, "쿠차", "세일즈헌터" 등 경쟁 가격비교
서비스는 언급하지 마세요. 영문 병기가 필요할 때는 반드시 "가신(Gasin)"
형태로 쓰세요.
